        ...
        <div class="max-w-4xl w-full flex flex-col lg:flex-row items-center space-y-8 lg:space-y-0 lg:space-x-12">
            ...
            <div class="w-full lg:w-1/2 max-w-md">
                <div class="bg-white shadow-lg rounded-lg p-8">
                    ...
                    <form action="{{ route('login') }}" method="POST" class="space-y-6">
                        ...
                        <p class="flex text-gray-400 justify-center items-center text-md">Don't have an account? <a class="text-gray-500 hover:text-gray-400" href="{{ route('register') }}">&nbsp;Create Account</a></p>
                    </form>
                </div>
            </div>
            ...
            <div class="w-full lg:w-1/2 flex justify-center">
                <div class="text-center">
                    <img src="{{ asset('img/SidoTanggapLogoNoBg.png') }}" alt="Auth Logo">
                </div>
            </div>
        </div>
    </div>
